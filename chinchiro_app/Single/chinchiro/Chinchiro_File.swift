...
extension ChinChiro_ViewController {

func Chinchiro(){
    
    let appdelegate = UIApplication.shared.delegate as! AppDelegate
    let er = appdelegate.send!
    let min = 1             //乱数の最低値を設定
    ...
    var i = Int(appdelegate.data!)
    appdelegate.data = String((i! + allresult))
    
    motiten_Label.text = appdelegate.data //持ち点表示
...
//
//        appDelegate.lastText = String(1000 + allresult)
//        pointLabel.text = appDelegate.lastText
//
//
//    }else{
//        appDelegate.lastText = String(Int(appDelegate.lastText!)! + allresult)
//        //a     appDelegate.lastText = String(1000 + allresult)
//        pointLabel.text = appDelegate.lastText
//
//    }
    /*
     a1 = Int(appDelegate.lastText!)
     kekka12 = (a1 + allresult)
     
     appDelegate.lastText = String(kekka12)
     pointLabel.text = appDelegate.lastText
     */
}
